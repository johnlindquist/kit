...
### Using node 16.14.2 from ~/.knode

Installing `Kit.app` already installed node 16.14.2 to ~/.knode. You'll want to use this node version for all build/run steps:

`PATH=~/.knode/bin:$PATH`

This will use 16.14.2's node/npm when working with Kit. (Alternatively, you can use nvm/n/whatever, but I don't)
