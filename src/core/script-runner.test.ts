...
export async function runScriptWithResult(scriptPath: string, scriptArgs: string[] = []): Promise<any> {
...
export async function runScriptModule(scriptPath: string, scriptArgs: string[] = []): Promise<any> {
  // Save original args
