...
<a href="submit:login" class="text-contrast-light dark:text-black font-bold px-3 py-3 h-6 no-underline rounded bg-black dark:bg-white bg-opacity-80 dark:bg-opacity-80 hover:opacity-75 dark:hover:opacity-75">Sign in with GitHub</a>
