...
exports.getActiveAppBounds = exports.setActiveAppBounds = exports.getMousePosition = exports.getActiveScreen = exports.tileWindow = exports.getScreens = exports.setWindowSize = exports.setWindowPositionByIndex = exports.organizeWindows = exports.scatterWindows = exports.setWindowBoundsByIndex = exports.setWindowSizeByIndex = exports.setWindowPosition = exports.getWindowsBounds = exports.focusWindow = exports.getWindows = void 0;
...
let focusWindow = async (process, title) => {
...
exports.getWindowsBounds = getWindowsBounds;
let setWindowPosition = async (process, title, x, y) => {
    return await applescript(String.raw `
	tell application "System Events"
	set theProcessWindow to window of process "${process}"
	repeat with theWindow in theProcessWindow
...
let setWindowSizeByIndex = async (process, index, x, y) => {
    return await applescript(String.raw `
		tell application "System Events"
		set theProcessWindow to window of process "${process}"
		set counter to 0
...
exports.setWindowSizeByIndex = setWindowSizeByIndex;
let setWindowBoundsByIndex = async (process, index, x, y, width, height) => {
    return await applescript(String.raw `
		  tell application "System Events"
		  set theProcessWindow to window of process "${process}"
		  set counter to 0
...
exports.setWindowBoundsByIndex = setWindowBoundsByIndex;
let scatterWindows = async () => {
    let { workArea } = await (0, exports.getActiveScreen)();
...
exports.scatterWindows = scatterWindows;
let organizeWindows = async () => {
    let { workArea } = await (0, exports.getActiveScreen)();
    let { x, y, width, height } = workArea;
    let windows = await (0, exports.getWindows)();
    ...
    windows.forEach(async (window, i) => {
        ...
        await (0, exports.setWindowSizeByIndex)(process, index, windowWidth, windowHeight);
        await (0, exports.setWindowPositionByIndex)(process, index, windowX, windowY);
    });
};
exports.organizeWindows = organizeWindows;
let setWindowPositionByIndex = async (process, index, x, y) => {
    return await applescript(String.raw `
		tell application "System Events"
		set theProcessWindow to window of process "${process}"
		set counter to 0
...
exports.setWindowPositionByIndex = setWindowPositionByIndex;
let setWindowSize = async (process, title, x, y) => {
    return await applescript(String.raw `
	  tell application "System Events"
	  set theProcessWindow to window of process "${process}"
	  repeat with theWindow in theProcessWindow
...
let tileWindow = async (app, leftOrRight) => {
    return await applescript(String.raw `
	tell application "System Events"
	tell process "${app}"
...
let getActiveScreen = async () => new Promise((res, rej) => {
    ...
    send(enum_1.Channel.GET_SCREEN_INFO);
});
exports.getActiveScreen = getActiveScreen;
let getMousePosition = async () => new Promise((res, rej) => {
    let messageHandler = data => {
    ...
    process.on("message", messageHandler);
    send(enum_1.Channel.GET_MOUSE);
});
exports.getMousePosition = getMousePosition;
let setActiveAppBounds = async ({ left, top, right, bottom, }) => {
...
exports.setActiveAppBounds = setActiveAppBounds;
let getActiveAppBounds = async () => {
...
exports.getActiveAppBounds = getActiveAppBounds;
