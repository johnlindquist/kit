export interface CLI {
  ...
  "set-env-var": Promise<
    typeof import("../cli/set-env-var")
  >
  "search-docs": Promise<
    typeof import("../cli/search-docs")
  >
  ...
  ["sync-path"]: Promise<typeof import("../cli/sync-path")>
  ["sync-path-instructions"]: Promise<
    typeof import("../cli/sync-path-instructions")
  >
}
