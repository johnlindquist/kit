let file = JSON.parse(await readFile(kenvPath("package.json"), {
    encoding: "utf8",
}));
let packages = (await arg(chalk `Which packages do you want to {red uninstall}`, [
...
let uninstallPackage = spawn(kitPath("node", "bin", "npm"), [
    "uninstall",
    "--prefix",
    kenvPath(),
    ...packages,
